    ...
    <div class="py-6">
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('restoran.kategori.edit', $kategori->id_kategori) }}" class="inline-flex items-center rounded-md bg-amber-500 px-3 py-2 text-xs font-semibold text-white hover:bg-amber-400">Edit Kategori</a>
