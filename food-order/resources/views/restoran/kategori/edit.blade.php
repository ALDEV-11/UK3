...
@section('content')
    <div class="py-6">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 space-y-4">
            <a href="{{ route('restoran.kategori.show', $kategori->id_kategori) }}" class="text-sm text-indigo-600 hover:text-indigo-700">← Kembali ke detail kategori</a>

            <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
                <h2 class="mb-4 text-lg font-semibold text-gray-900">Edit Kategori Menu</h2>
