    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="flex items-center justify-between gap-3">
                <h2 class="text-lg font-semibold text-gray-900">Kategori Menu</h2>
                <a href="{{ route('restoran.kategori.create') }}" class="inline-flex items-center rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-white hover:bg-indigo-500">+ Tambah Kategori</a>
            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 text-sm">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-4 py-3 text-left font-medium text-gray-600">Nama Kategori</th>
                        ...
                        <tbody class="divide-y divide-gray-100 bg-white">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-right">
                                        <div class="inline-flex items-center gap-3">
                                            <a href="{{ route('restoran.kategori.show', $item->id_kategori) }}" class="text-indigo-600 hover:text-indigo-700">Detail</a>
                                            <a href="{{ route('restoran.kategori.edit', $item->id_kategori) }}" class="text-amber-600 hover:text-amber-700">Edit</a>
                            ...
                            @empty
                                <tr><td colspan="4" class="px-4 py-6 text-center text-gray-500">Belum ada kategori.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
