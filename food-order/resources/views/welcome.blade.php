...
<html lang="en" data-theme="light" data-assets-path="assets/" data-layout-path="free-landing-page/" dir="ltr" class="scroll-smooth">
  <head>
    ...
    <title>SantapKu - Order Makanan Online</title>

    <meta name="description" content="SantapKu adalah platform pemesanan makanan online yang memudahkan Anda memesan dari berbagai restoran pilihan dengan diskon menarik." />
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('dist-landing/assets/img/favicon/favicon.ico') }}" />
    ...
    <!-- Vendor CSS -->
    <link rel="stylesheet" href="{{ asset('dist-landing/assets/dist/libs/flatpickr/dist/flatpickr.css') }}" />

    <!-- build:css -->
    <link rel="stylesheet" href="{{ asset('dist-landing/assets/dist/css/output.css') }}" />

    <!-- SantapKu Custom Theme -->
    <link rel="stylesheet" href="{{ asset('dist-landing/assets/css/santapku.css') }}" />
  ...
  <body>
      ...
      <main>
        ...
        <section id="home">
          <div class="gap-18 md:pt-45 lg:gap-35 lg:pt-47.5 flex h-full flex-col justify-between bg-[url('../../img/free-layer-blur.png')] bg-cover bg-center bg-no-repeat py-8 pt-40 sm:py-16 md:gap-24 lg:py-24">
            ...
            <img src="{{ asset('dist-landing/assets/img/dishes-hero.png') }}" alt="Dishes" class="min-h-67 w-full object-cover" />
          </div>
        </section>
        <!-- About us -->
        <section id="about-us">
            ...
            <div class="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
              <div class="flex flex-col gap-12 md:gap-16 lg:gap-24">
                ...
                <div class="lg:h-161 relative mb-8 h-full w-full rounded-xl max-lg:space-y-6 sm:mb-16 lg:mb-24">
                  <img src="{{ asset('dist-landing/assets/img/restaurant-about-us.png') }}" alt="about-us" class="h-full w-full rounded-xl object-cover" />
            ...
            <div class="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
              ...
              <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="card card-border shadow-none">
                  <figure>
                    <img src="{{ asset('dist-landing/assets/img/free-blog-1.png') }}" alt="Vegetable Market" />
                  </figure>
                ...
                <div class="card card-border shadow-none">
                  <figure>
                    <img src="{{ asset('dist-landing/assets/img/free-blog-2.png') }}" alt="Delivery Service" />
                  </figure>
                  <div class="card-body gap-3">
                ...
                <div class="card card-border shadow-none">
                  <figure>
                    <img src="{{ asset('dist-landing/assets/img/free-blog-3.png') }}" alt="Cafeteria" />
                  </figure>
                  <div class="card-body gap-3">
        ...
        <section id="vouchers">
          <div class="bg-base-100 py-8 sm:py-16 lg:py-24">
            <div class="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
              <!-- Section Header -->
              <div class="mb-12 space-y-4 text-center sm:mb-16 lg:mb-24">
                <h2 class="text-base-content text-2xl font-semibold md:text-3xl lg:text-4xl">Special Offers & Vouchers</h2>
                <p class="text-base-content/80 text-xl">Get exclusive discounts on your next order</p>
              </div>
              <!-- Vouchers Grid -->
              <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                @php
                  $vouchers = \DB::table('voucher')->limit(4)->get();
                @endphp
                @forelse($vouchers as $voucher)
                  <div class="card card-border shadow-none bg-gradient-to-br from-primary/10 to-accent/10 hover:shadow-md transition-shadow">
                    <div class="card-body">
                      <div class="flex items-start justify-between">
                        <div class="flex-1">
                          ...
                          <p class="text-base-content/70 mt-2">{{ $voucher->kode_voucher }}</p>
                          <div class="flex items-center gap-4 mt-4 text-sm">
                            <span class="flex items-center gap-1">
                              <span class="icon-[tabler--cash] text-success size-4"></span>
                              Min: Rp {{ number_format($voucher->min_pesanan, 0, ',', '.') }}
                            </span>
                            <span class="flex items-center gap-1">
                              <span class="icon-[tabler--ticket] text-info size-4"></span>
                              Stock: {{ $voucher->stok }}
                            </span>
                          </div>
                          <p class="text-xs text-base-content/50 mt-2">
                            Valid until {{ \Carbon\Carbon::parse($voucher->tgl_kadaluarsa)->format('d M Y') }}
                          </p>
                        </div>
                        <div class="text-right">
                          <button class="btn btn-primary btn-sm">Copy Code</button>
                        </div>
                      </div>
                    </div>
                  </div>
                @empty
                  <div class="col-span-full text-center py-12">
                    <p class="text-base-content/60">No active vouchers at the moment</p>
                  </div>
                @endforelse
              </div>
            </div>
                        ...
                        <div class="flex items-center gap-3">
                          <div class="avatar">
                            <div class="size-10 rounded-full">
                              <img src="{{ asset('dist-landing/assets/img/avatars/7.png') }}" alt="Craig Bator" />
                            </div>
                          </div>
                          <div>
                    ...
                    <div class="card card-border hover:border-primary transition-border h-full shadow-none duration-300">
                      ...
                      <div class="card-body gap-5">
                        ...
                        <div class="flex items-center gap-3">
                          <div class="avatar">
                            <div class="size-10 rounded-full">
                              <img src="{{ asset('dist-landing/assets/img/avatars/2.png') }}" alt="Craig Bator" />
                            </div>
                          </div>
                          <div>
                    ...
                    <div class="card card-border hover:border-primary transition-border h-full shadow-none duration-300">
                      ...
                      <div class="card-body gap-5">
                        ...
                        <div class="flex items-center gap-3">
                          <div class="avatar">
                            <div class="size-10 rounded-full">
                              <img src="{{ asset('dist-landing/assets/img/avatars/3.png') }}" alt="Alexandra Lee" />
                            </div>
                          </div>
                          <div>
                    ...
                    <div class="card card-border hover:border-primary transition-border h-full shadow-none duration-300">
                      ...
                      <div class="card-body gap-5">
                        ...
                        <div class="flex items-center gap-3">
                          <div class="avatar">
                            <div class="size-10 rounded-full">
                              <img src="{{ asset('dist-landing/assets/img/avatars/12.png') }}" alt="Jason Wu" />
                            </div>
                          </div>
                          <div>
              ...
              <div class="bg-base-100 rounded-3xl p-0.5">
                <div class="from-primary/6 to-error/6 relative rounded-3xl bg-gradient-to-r to-50% p-8 lg:p-16">
                  <div class="flex justify-between gap-8 max-md:flex-col max-sm:items-center max-sm:text-center md:items-center">
                    ...
                    <img src="{{ asset('dist-landing/assets/img/mint.png') }}" alt="mint" class="intersect-once intersect:motion-preset-slide-down-lg intersect:motion-duration-800 intersect:motion-opacity-in-0 intersect:motion-delay-100 absolute end-[21%] top-0 h-20 max-w-sm max-md:hidden" />
                    <img src="{{ asset('dist-landing/assets/img/pizza.png') }}" alt="Pizza" class="rtl:rotate-y-180 absolute end-0 top-0 h-full max-w-md rounded-br-3xl max-md:hidden" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="card card-border hover:border-primary h-max shadow-none">
                  <figure class="bg-base-200 pt-10.5">
                    <img src="{{ asset('dist-landing/assets/img/chef-1.png') }}" alt="Cheyenne Workman" class="h-60 w-auto" />
                  </figure>
                ...
                <div class="card card-border hover:border-primary h-max shadow-none">
                  <figure class="bg-base-200 pt-10.5">
                    <img src="{{ asset('dist-landing/assets/img/chef-2.png') }}" alt="Corey Rosser" class="h-60 w-auto" />
                  </figure>
                  <div class="card-body gap-3 p-5">
                ...
                <div class="card card-border hover:border-primary h-max shadow-none">
                  <figure class="bg-base-200 pt-10.5">
                    <img src="{{ asset('dist-landing/assets/img/chef-3.png') }}" alt="Marilyn Westervelt" class="h-60 w-auto" />
                  </figure>
                  <div class="card-body gap-3 p-5">
                ...
                <div class="card card-border hover:border-primary h-max shadow-none">
                  <figure class="bg-base-200 pt-10.5">
                    <img src="{{ asset('dist-landing/assets/img/chef-4.png') }}" alt="Ryan Passaquindici Arcand" class="h-60 w-auto" />
                  </figure>
                  <div class="card-body gap-3 p-5">
    ...
    <!-- Vendors JS -->
    <script src="{{ asset('dist-landing/assets/dist/libs/tailwindcss-intersect/dist/observer.min.js') }}"></script>
    <script src="{{ asset('dist-landing/assets/dist/libs/flatpickr/dist/flatpickr.js') }}"></script>

    <!-- FlyonUI JS -->
    <script src="{{ asset('dist-landing/assets/dist/libs/flyonui/flyonui.js') }}"></script>

    <!-- Theme Utils JS -->
    <script src="{{ asset('dist-landing/assets/js/theme-utils.js') }}"></script>

    <!-- Main JS -->
    <script src="{{ asset('dist-landing/assets/js/main.js') }}"></script>

    <!-- Page JS -->
    <script src="{{ asset('dist-landing/assets/js/landing-page-free.js') }}"></script>
