                ...
                <table role="presentation" class="container" width="640" cellpadding="0" cellspacing="0" style="max-width:640px; background:#ffffff; border-radius:14px; overflow:hidden; border:1px solid #fed7aa;">
                    ...
                    <tr>
                        <td class="content" style="padding:24px;">
                            <h1 class="title" style="margin:0 0 12px; font-size:24px; line-height:1.3; color:#c2410c;">Pesanan Sedang Dalam Perjalanan!</h1>
                            <p style="margin:0 0 16px; font-size:14px; line-height:1.6;">Kurir sedang mengantarkan pesanan kamu ke alamat tujuan.</p>
                            ...
                            <div style="background:#fff7ed; border:1px solid #fdba74; border-radius:10px; padding:14px;">
                                ...
                                <p style="margin:0; font-size:13px;"><strong>Alamat Pengiriman:</strong> {{ $pesanan->alamat_kirim ?? '-' }}</p>
                            </div>
                        </td>
                    </tr>
                    <tr>
