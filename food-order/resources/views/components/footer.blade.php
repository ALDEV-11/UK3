<footer>
    ...
    <div class="mx-auto max-w-[1280px] px-4 py-8 sm:px-6 lg:px-8">
      <div class="text-base-content text-center text-base">
        &copy;2025
        <a href="index.html" class="text-primary">SantapKu</a>
        ,
        <br class="md:hidden" />
        Made With ❤️ for better food delivery • Distributed by <a href="https://themewagon.com" target="_blank" class="text-primary">ThemeWagon</a>
      </div>
    </div>
  </footer>
