    ...
    <div class="py-6">
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
                <h2 class="mb-4 text-lg font-semibold text-gray-900">Tambah Voucher</h2>
                ...
                <form method="POST" action="{{ route('admin.voucher.store') }}" class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="kode_voucher" value="{{ old('kode_voucher') }}" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm" required>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" name="nilai_diskon" value="{{ old('nilai_diskon', 0) }}" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm" required>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" name="min_pesanan" value="{{ old('min_pesanan', 0) }}" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm" required>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" name="maks_diskon" value="{{ old('maks_diskon', 0) }}" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm" required>
                    ...
                    <div>
                        ...
                        <input type="date" name="tgl_berlaku" value="{{ old('tgl_berlaku') }}" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm" required>
                    ...
                    <div>
                        ...
                        <input type="date" name="tgl_kadaluarsa" value="{{ old('tgl_kadaluarsa') }}" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm" required>
                        @error('tgl_kadaluarsa')<p class="mt-1 text-xs text-rose-600">{{ $message }}</p>@enderror
                    </div>

                    <div class="md:col-span-2">
                        <button type="submit" class="rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-white hover:bg-indigo-500">Simpan Voucher</button>
                    </div>
                </form>
            </div>
        </div>
