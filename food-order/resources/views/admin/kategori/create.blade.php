...
@section('content')
    <div class="py-6">
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-4">
            <a href="{{ route('admin.kategori.index') }}" class="text-sm text-indigo-600 hover:text-indigo-700">← Kembali ke daftar kategori</a>
            ...
            <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
                ...
                <form method="POST" action="{{ route('admin.kategori.store') }}" class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="icon" value="{{ old('icon') }}" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm">
