...
@section('content')
    <div class="py-6">
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-4">
            <a href="{{ route('admin.menu.show', $menu->id_menu) }}" class="text-sm text-indigo-600 hover:text-indigo-700">← Kembali ke detail menu</a>
                ...
                <form method="POST" action="{{ route('admin.menu.update', $menu->id_menu) }}" enctype="multipart/form-data" class="grid grid-cols-1 gap-4">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                        <div>
                            ...
                            <input type="number" min="0" step="0.01" name="harga" value="{{ old('harga', (float) $menu->harga) }}" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm" required>
